...
import aracna.src.models.bi_mamba as bi_mamba
from aracna.src.models import standalone_hyenadna as hyena
...
class MambaBackbone(nn.Module):
    ...
    def __init__(
        ...
        # output of Add) and the main branch (output of MLP / Mixer).
        # The model definition is unchanged.

        self.layers = nn.ModuleList(
            [
                bi_mamba.create_block(
                    d_model,
                    d_intermediate,
                    ssm_cfg=ssm_cfg,
